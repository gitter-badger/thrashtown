...
var SurfSchema = new Schema({
  ...
  waveQuality: {type: Number, min: 1, max: 5, requred: false},
  hollowness: {type: Number, min: 1, max: 5, requred: false},
  funFactor: {type: Number, min: 1, max: 5, requred: false},
  ...
  collection: 'surfs' // bug with Mongoose pluarizing 'surf' to 'surves'
});
